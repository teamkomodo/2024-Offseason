...
public final class Constants {
    ...
    public static final double BACK_RIGHT_STEER_OFFSET = -Math.toRadians(36.570);
    ...
    public static final double BACK_LEFT_STEER_OFFSET = -Math.toRadians(37.336);
    ...
    public static final double FRONT_RIGHT_STEER_OFFSET = -Math.toRadians(40.036);
    ...
    public static final double FRONT_LEFT_STEER_OFFSET = -Math.toRadians(32.653);
